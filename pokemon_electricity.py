...
class PokemonElectricity(Pokemon):
    ...
    def fight_attack(self, pokemon_to_attack):
        damage = self.attack_rating
        if randint(0,1) == 1:
            damage = damage * 2      
        return pokemon_to_attack.fight_defense(damage)
...
def main():
    ...
    print("=================================================================.")
    pokemon_1 = PokemonElectricity(
        1, "Pikachu", WeaponType.HEADBUTT, 100, 8, 7)
    ...
    print("=================================================================.")
    pokemon_2 = PokemonElectricity(
        7, "Pikachu", WeaponType.HEADBUTT, 100, 7, 6)
